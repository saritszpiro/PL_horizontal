...
%      screen params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
screenVar = struct('num', {1}, 'rectPix',{[0 0  1280 960]}, 'dist', {57}, 'size', {[38 29]},...
...
fixationVar = struct( 'color',{[black black black 255]},'dur', {0.5}, 'penWidthPix', {2.5}, 'bkColor', screenVar.bkColor,...
                      'sizeCrossDeg', {[0.2 0.2]}, 'colorDisc', {[black black black 255]}); 
...
%      stimuli params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
stim = struct('dur', {0.2}, 'possibleAngels', {[10 350]},'boundaryAngle', {[0 0]},...
    'radiusDeg',{3}, 'bkColor', {gray}, 'speedDegPerSec', {10},'lifetime', {1}, 'limitLifetime', {0.05});
% [3 357 183 177]
...
%      Stair params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
stair = struct( 'runStair',{1},'numStaircases', {2}, ...
                'maxThresh', {1}, 'minThresh', {.03},'minStepsize', {.03},...
                'startStepsize', {[.1 .2] },'startValues', {[0.2 0.4]},...
                'nonStairCoh',{NaN});
...
responseVar = struct( 'allowedRespKeys', {['6', '3']}, 'dur',{5},'keyEscape', 'ESCAPE', 'percentEstimation', {0});
