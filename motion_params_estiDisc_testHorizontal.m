...
%      stimuli params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
stim = struct('dur', {0.8}, 'possibleAngels', {[3 357 183 177]},'boundaryAngle', {[0 0 180 180]},...
    'radiusDeg',{8}, 'bkColor', {gray}, 'coh', {0.08}, 'speedDegPerSec', {10},'lifetime', {1}, 'limitLifetime', {0.05});
...
responseVar = struct( 'allowedRespKeys', {['g', 'b']}, 'dur',{5},'keyEscape', 'ESCAPE', 'percentEstimation', {0.5});
