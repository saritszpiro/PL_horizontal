...
fixationVar = struct( 'color',{[black black black 255]},'dur', {.5}, 'penWidthPix', {2.5}, 'bkColor', screenVar.bkColor,...
...
%      stimuli params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
stim = struct('dur', {.5}, 'possibleAngels', {[7 353]},'boundaryAngle', {[0 0]},...
...
stair = struct( 'runStair',{0},'numStaircases', {3}, 'numDownStep',{[2 2 2]},...
                ...
                'startStepsize', {[.2 .2 .2] },'startValues', {[0.45 0.55 .35]},...
                'nonStairCoh',{.4});
...
%      Trial params
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
trialVars = struct('numTrialsPerBlock', {20}); %total number of trials across blocks
...
cl = 1;
if cl
    clear white gray black locationL locationR screenVar stim fixationVar precueExg box postCueVar responseVar numdotsperdeg;
